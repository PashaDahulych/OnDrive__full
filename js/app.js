(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".record-second__slider")) new core(".record-second__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4.5,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".record-second-slide__arrow-left.swiper-button-prev",
                    nextEl: ".record-second-slide__arrow-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.5,
            ...
            if (document.querySelector(".record-third__slider")) new core(".record-third__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".record-third-slide__arrow-left.swiper-button-prev",
                    nextEl: ".record-third-slide__arrow-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.5,
            ...
            if (document.querySelector(".popup-testination__wrapper")) {
                ...
                new core(".images-product__slider", {
                    ...
                    navigation: {
                        prevEl: ".images-product__arrow-left.swiper-button-prev",
                        nextEl: ".images-product__arrow-right.swiper-button-next"
                    },
                    on: {}
                });
            }
        ...
        const qsNums = document.querySelectorAll(".qs-current");
        const checkboxes = document.querySelectorAll(".checkbox");
        qsNums.forEach(((qsNum, index) => {
            qsNum.addEventListener("mouseover", (() => {
                checkboxes[index].style.opacity = "1";
                checkboxes[index].style.visibility = "visible";
            }));
            const checkboxLines = checkboxes[index].querySelectorAll(".checkbox__line");
            checkboxLines.forEach((checkboxLine => {
                checkboxLine.addEventListener("click", (e => {
                    e.stopPropagation();
                    checkboxes[index].style.opacity = "0";
                    checkboxes[index].style.visibility = "hidden";
                }));
            }));
        }));
